...
public class WishListPage {
    ...
    public void addfirstProduct(WebDriver driver)  {
        WebElement addEle = driver.findElement(By.id("add-to-wishlist-button-4"));
        addEle.click();
    }
    ...
    public void SecondCategories(WebDriver driver){
        ...
        By secondcategory = By.xpath("//div//img[@alt=\"Picture of If You Wait (donation)\"]");
    ...
    public void addsecondProduct(WebDriver driver){
        WebElement addSecondEle = driver.findElement(By.id("add-to-wishlist-button-38"));
        addSecondEle.click();

        }

    public void ClickCartwishlist (WebDriver driver){
        WebElement clickCartEle = driver.findElement(By.className("wishlist-label"));
        clickCartEle.click();
    }
